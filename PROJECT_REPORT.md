...
The pipeline is designed using a modular, decoupled architecture consisting of five core components:
...
*   **Total Callback Processing Latency (CPU-only):** $\sim 800\text{-}900\text{ms}$ per frame (optimized down from $\sim 1500\text{ms}$).
